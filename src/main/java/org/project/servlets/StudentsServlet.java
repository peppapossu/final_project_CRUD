...
import static org.project.service.StudentService.*;
...
public class StudentsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (req.getRequestURI().startsWith("/" + STUDENTS + "/")) {
            result = getStudentById(req,jsonService);
        } else {result = generateStudentsList(req,jsonService);}
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        if (addStudentFromReq(req,jsonService)) {
